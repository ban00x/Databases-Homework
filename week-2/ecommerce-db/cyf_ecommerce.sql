...
-- 2 Retrieve all the customers ordered by ascending nameSELECT name, address FROM customers WHERE country= 'United States';
...
SELECT product_name, unit_price, quantity FROM orders o
...
INNER JOIN suppliers s ON p.supplier_id=o.customer_id
